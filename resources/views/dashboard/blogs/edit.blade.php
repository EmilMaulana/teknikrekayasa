                ...
                <form method="POST" action="/dashboard/blog/{{ $blog->slug }}/update" enctype="multipart/form-data">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2 sm:gap-6 mt-5">
                        ...
                        <div class="mb-4">
                            ...
                            @if ($blog->image) <!-- Preview image dari database -->
                                <div class="mt-2">
                    ...
                    <div class="mt-5">
                        ...
                        <textarea name="body" id="myeditor" rows="7" class="" placeholder="Leave a comment...">{{ old('body', $blog->body) }}</textarea>
                        @error('body')
                            <div class="mt-2 text-xs text-red-600 dark:text-red-400">
                                <span class="font-medium">Oh, snapp!</span> {{ $message }}
                            </div>
