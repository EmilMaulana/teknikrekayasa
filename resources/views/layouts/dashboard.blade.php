...
<body>
    <div class="flex h-screen bg-gray-50 dark:bg-gray-900" class="{ 'overflow-hidden': isSideMenuOpen }">
        ...
        <aside
            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    ...
                    <li class="relative px-6 py-3">
                        <span class="{{ request()->routeIs('blog.index') ? 'absolute inset-y-0 left-0 w-1 bg-purple-600 rounded-tr-lg rounded-br-lg' : '' }} " aria-hidden="true"></span>
                        <a class="inline-flex items-center w-full text-sm font-semibold text-gray-800 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 dark:text-gray-100" href="{{ route('blog.index') }}">
                            <svg
                            class="w-5 h-5"
                            aria-hidden="true"
        ...
        <div class="flex flex-col flex-1 w-full">
                ...
                <li class="relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent leading-4 font-medium rounded-md text-white transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
            ...
            {{-- section content --}}
            <main class="h-full overflow-y-auto mt-5">
        ...
        <script>
            tinymce.init({
                ...
                plugins: 'visualblocks preview pagebreak image fullscreen code table lists emoticons',
                toolbar: 'visualblocks | preview | pagebreak | image | fullscreen | emoticons | undo redo | blocks | bold italic | alignleft aligncenter alignright | indent outdent | bullist numlist | code | table'
            });
        </script>
    </body>
</html>